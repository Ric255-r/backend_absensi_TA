    ...
    async with pool.acquire() as conn:
      async with conn.cursor(aiomysql.DictCursor) as cursor:
        ...
        try:
          ...
          """
          q1_values = (
            data['id_karyawan'], data['nama_karyawan'], data['email_karyawan'], data['nomor_hp'], 
            data['tanggal_rekrut'], data['status'], data['id_departemen'], data['posisi']
          )
    ...
    async with pool.acquire() as conn:
      async with conn.cursor(aiomysql.DictCursor) as cursor:
        ...
        try:
          ...
          q1_values = (
            data['username'], passwd.hexdigest(), data['roles'],
...
async def generate_dummy_attendance():
    ...
    employee_ids = ['K003', 'K005', 'K006', 'K007', 'K008', 'K009', 'K010', 'K011', 'K012']
